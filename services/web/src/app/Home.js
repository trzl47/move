	...
	render() {
		return(
			<div className={[css.move].join(' ')}>
				...
				<div className={[css.feature].join(' ')}>
					<div className={['container'].join(' ')}>
				...
				<div className={[css.supporting].join(' ')}>
					<div className={['container'].join(' ')}>
						...
						<Link className={['btn', css.btn].join(' ')} to="/MOVE/Gear">Learn More</Link>
					</div>
				</div>
				<div className={[css.footer].join(' ')}>
					<div className={['container'].join(' ')}>
						<h2>Stop scrolling. Start moving</h2>
						<Link className={['btn', css.btn].join(' ')} to="/MOVE/Gear">Start Now</Link>
					</div>
				</div>
				<ul className={[css['ui-autocomplete'],css['ui-front'],css['ui-menu'],css['ui-widget'],css['ui-widget-content']].join(' ')} id="ui-id-1" tabIndex="0" style={['display: none; position: relative, top: -1968.38px, left: 790px, width: 322px,']}>
					<li className={css['ui-menu-item']} id="ui-id-41" tabIndex="-1">Tokyo</li>
					<li className={css['ui-menu-item']} id="ui-id-42" tabIndex="-1">New York</li>
					<li className={css['ui-menu-item']} id="ui-id-43" tabIndex="-1">Jakarta</li>
					<li className={css['ui-menu-item']} id="ui-id-44" tabIndex="-1">Keihanshin</li>
					<li className={css['ui-menu-item']} id="ui-id-45" tabIndex="-1">Hong Kong</li>
					<li className={css['ui-menu-item']} id="ui-id-46" tabIndex="-1">Kolkata</li>
					<li className={css['ui-menu-item']} id="ui-id-47" tabIndex="-1">Karachi</li>
				</ul>
				<span role="status" aria-live="assertive" aria-relevant="additions" className={css['ui-helper-hidden-accessible']}>
